...
import { registerPaypalApiHealthRoutes } from './routes/health.routes.js';
import { registerPaypalApiAccountsRoutes } from './routes/accounts.routes.js';
import { registerPaypalApiProfilesRoutes } from './routes/profiles.routes.js';
import { registerPaypalApiTransactionsRoutes } from './routes/transactions.routes.js';
import { registerPaypalApiBalancesRoutes } from './routes/balances.routes.js';
...
export function register(app, ctx = {}) {
  try { registerPaypalApiHealthRoutes(app, ctx); } catch {}

  try {
    const key = '/api/paypal-api';
  ...
  registerPaypalApiAccountsRoutes(app, ctx);
  registerPaypalApiProfilesRoutes(app, ctx);
  registerPaypalApiTransactionsRoutes(app, ctx);
  registerPaypalApiBalancesRoutes(app, ctx);
}
