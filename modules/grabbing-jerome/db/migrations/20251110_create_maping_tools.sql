-- Create mapping tools table: per (domain, page_type, version) with optional org_id
...
-- Helpful indexes
CREATE INDEX IF NOT EXISTS mod_gj_maping_domain_type_idx ON public.mod_grabbing_jerome_maping_tools (domain, page_type);
CREATE INDEX IF NOT EXISTS mod_gj_maping_org_idx ON public.mod_grabbing_jerome_maping_tools (org_id);
