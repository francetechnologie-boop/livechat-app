/**
 * testmcp Module Installer
 * - Ensures system tables
 * - Applies SQL migrations under modules/testmcp/db/migrations
 */
...
// Resolve module root robustly across platforms (avoid mixed path separators)
...
export async function installModule() {
  ...
  const { name = 'testmcp', version = '1.0.0', enabled = true } = JSON.parse(fs.readFileSync(configPath, 'utf8'));
